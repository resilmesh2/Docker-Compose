...
duration_seconds=$(($duration % 60))
{
    ...
    echo -e "- resilmesh_network has been created: IP 172.19.0.0"
    ...
    echo -e "- Script duration: $duration_minutes minutes and $duration_seconds seconds."
    ...
    printf "$SEPARATOR\n"
    printf "| %-20s | %-26s | %-8s | %-15s | %-5s | %-62s |\n" "Situation Assessment" "NSE Flask Risk API" "HTTP" "$SERVER_IP" "5000" "http://$SERVER_IP:5000"
    printf "$SEPARATOR\n"
