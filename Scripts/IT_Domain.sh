...
read -p "\nDo you want to share IoBs with someone? (y/n): " answer_iob1
if [[ "$answer_iob1" == "y" || "$answer_iob1" == "Y" ]]; then
    read -p "\nIntroduce your peer's URL (<IP>:<PORT>): " peer_url
...
read -p "\nDo you want to receive the IoBs? (y/n): " answer_iob2
...
if [[ "$IOB_PEER_URL" != "" ]]; then
    echo -e "- You have entered the following PEER_URL for IoB component: $IOB_PEER_URL"
else
    echo -e "- You have not entered any PEER_URL for IoB component."
fi

if [[ "$IOB_PEER_AUTH_TOKEN" != "" ]]; then
    echo -e "- You have entered the following PEER_AUTH_TOKEN for IoB component: $IOB_PEER_AUTH_TOKEN"
else
    echo -e "- You have not entered any PEER_AUTH_TOKEN for IoB component."
fi
